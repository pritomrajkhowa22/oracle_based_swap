...
export function tokenQtyToNumber(x: BigNumber, decimals: number): number {
  ...
  // fix the overflow issue. BigNumber.toNumber() will overflow if the number is too large
  // Convert to string before dividing to avoid overflow
  return parseFloat(divided.toString()) / 1000000;
}
